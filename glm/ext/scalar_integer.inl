...
namespace glm {
	...
	GLM_FUNC_QUALIFIER genIUType nextMultiple(genIUType Source, genIUType Multiple) {
        ...
        return detail::compute_ceilMultiple<std::numeric_limits<genIUType>::is_iec559, std::numeric_limits<
            genIUType>::is_signed>::call(Source, Multiple);
    }
	...
	GLM_FUNC_QUALIFIER genIUType prevMultiple(genIUType Source, genIUType Multiple) {
        ...
        return detail::compute_floorMultiple<std::numeric_limits<genIUType>::is_iec559, std::numeric_limits<
            genIUType>::is_signed>::call(Source, Multiple);
    }
