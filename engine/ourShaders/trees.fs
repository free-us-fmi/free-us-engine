...
// uniforms (provide from your application)
...
void main()
{
    ...
    // final color: invert rgb and alpha based on distance
    FragColor = vec4(1.0 - col.xyz, clamp(1.0 - col.w / MAXDIST, 0.0, 1.0));
}
