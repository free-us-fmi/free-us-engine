...
bool application::Initialize()
{
	...
	programs::AddProgram("jumpingUmbrellas", shaders::GetShadersPath() + "raymarching/raymarch.vs", shaders::GetShadersPath() + "../../ourShaders/jumpingUmbrellas.fs");
	programs::GetProgram("jumpingUmbrellas")->_editor_visible = true;
	programs::GetProgram("jumpingUmbrellas")->_unloadable = false;
