...
namespace editor::entity
{
	...
	void update()
	{
		...
		float available_height = ImGui::GetContentRegionAvail().y - button_height - ImGui::GetStyle().ItemSpacing.y;

		ImGui::BeginChild("EntityList", ImVec2(0, available_height), true);
		{
		...
		if (ImGui::Button("Add entity", ImVec2(-1, button_height)))
		{
